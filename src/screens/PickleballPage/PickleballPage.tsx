...
export const PickleballPage = (): JSX.Element => {
  // League card data for pickleball
  const leagueCards = [
    {
      title: "Advanced Singles",
      image: "/pickleball-card.jpg",
      link: "/leagues/pickleball-advanced-singles"
    },
    {
      title: "Intermediate Doubles",
      image: "/pickleball.png",
      link: "/leagues/pickleball-intermediate-doubles"
    },
    {
      title: "Competitive Singles",
      image: "/pickleball-card.jpg",
      link: "/leagues/pickleball-competitive-singles"
    },
    {
      title: "Coed Intermediate Doubles",
      image: "/pickleball.png",
      link: "/leagues/pickleball-coed-intermediate"
    },
    {
      title: "Advanced Doubles",
      image: "/pickleball-card.jpg",
      link: "/leagues/pickleball-advanced-doubles"
    },
    {
      title: "Competitive Doubles",
      image: "/pickleball.png",
      link: "/leagues/pickleball-competitive-doubles"
    },
  ];
    ...
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white w-full relative">
        ...
        >
          <div className="text-center text-white">
            ...
            <p className="text-xl max-w-2xl mx-auto mb-8">
              OFSL's pickleball leagues offer competitive play for all skill levels, from intermediate to advanced players. Experience fast-paced action and improve your game in a supportive community environment.
            </p>
        ...
        <div className="max-w-[1280px] mx-auto px-4 pt-16 md:pt-24 pb-8 md:pb-12">
          ...
          {/* About pickleball leagues text */}
          <div className="text-center mb-12">
            <p className="max-w-[1080px] mx-auto font-normal text-[#6f6f6f] text-base md:text-lg leading-6 md:leading-7">
              OFSL pickleball leagues feature both singles and doubles play across multiple skill levels. Our leagues are designed to provide competitive matches while maintaining a fun and inclusive atmosphere. Whether you're looking to improve your technique or compete at a high level, we have a league that's right for you.
            </p>
          </div>
        ...
        <div className="max-w-[1280px] mx-auto px-4 mb-16 md:mb-24">
          ...
          {/* About our pickleball leagues section with 2 columns */}
          <div className="mt-[91px] grid grid-cols-1 md:grid-cols-2 gap-12 mb-20 md:mb-28">
            ...
            <div className="flex flex-col justify-center">
              <h3 className="text-2xl md:text-3xl font-bold text-[#6F6F6F] mb-6">About our pickleball leagues</h3>
              <ul className="space-y-3 text-[#6F6F6F] text-base md:text-lg mb-8">
                ...
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>Professional-grade equipment provided for all league play.</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
              ...
              <Link to="/leagues?sport=Pickleball" className="self-start">
        ...
        <div className="w-full py-12 md:py-16" style={{ background: 'linear-gradient(90deg, rgba(178,0,0,1) 0%, rgba(120,18,18,1) 100%)' }}>
          <div className="max-w-[1280px] mx-auto px-4 text-center text-white">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Join our pickleball community and experience competitive play at your skill level.
            </p>
            <Link to="/leagues?sport=Pickleball">
              <Button
                variant="outline"
