                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200">
                    ...
                    {league.skillLevel === 'Competitive' && (
                      <ul className="space-y-2 text-[#6F6F6F]">
                        ...
                        <li className="flex items-start">
                          <span className="mr-2">•</span>
                          <span>Team-based play with complex systems</span>
                        </li>
                      </ul>
                    )}
                    ...
                    {league.skillLevel === 'Intermediate' && (
                      <ul className="space-y-2 text-[#6F6F6F]">
                        ...
                        <li className="flex items-start">
                          <span className="mr-2">•</span>
                          <span>Understanding of game rules and strategy</span>
                        </li>
                        <li className="flex items-start">
                          <span className="mr-2">•</span>
                          <span>Ability to sustain rallies and execute plays</span>
                        </li>
                      </ul>
                    )}
                  </div>
                          ...
                          <CardContent className="p-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                              ...
                              <div className="text-center p-3 bg-gray-50 rounded">
                                <div className="text-xs text-[#6F6F6F] mb-1">#{tier.teams.A?.ranking || 'TBD'}</div>
                                <div className="font-medium text-sm text-[#6F6F6F]">
                                  {tier.teams.A?.name || 'TBD'}
                                </div>
                                <div className="text-xs text-[#6F6F6F] mt-1">{tier.courts.A}</div>
                              </div>

                              {/* VS */}
                              <div className="flex items-center justify-center">
                                <span className="text-xs font-medium text-[#6F6F6F]">VS</span>
                              </div>

                              {/* Team B */}
                              <div className="text-center p-3 bg-gray-50 rounded">
                                <div className="text-xs text-[#6F6F6F] mb-1">#{tier.teams.B?.ranking || 'TBD'}</div>
                                <div className="font-medium text-sm text-[#6F6F6F]">
                                  {tier.teams.B?.name || 'TBD'}
                                </div>
                                <div className="text-xs text-[#6F6F6F] mt-1">{tier.courts.B}</div>
                              </div>
                            </div>
                            ...
                            {tier.teams.C && (
                              <div className="mt-3 pt-3 border-t border-gray-200">
                                <div className="text-center p-3 bg-gray-50 rounded">
                                  <div className="text-xs text-[#6F6F6F] mb-1">#{tier.teams.C.ranking}</div>
                                  <div className="font-medium text-sm text-[#6F6F6F]">
                                    {tier.teams.C.name}
                                  </div>
                                  <div className="text-xs text-[#6F6F6F] mt-1">{tier.courts.C}</div>
                                  <div className="text-xs text-[#6F6F6F] mt-1">(Bye week)</div>
                                </div>
                              </div>
                            )}
                          </CardContent>
                    ...
                    <tbody>
                      {mockStandings.map((team, index) => (
                        <tr key={team.id} className="border-b border-gray-100 hover:bg-gray-50">
                          <td className="py-3 px-4 text-[#6F6F6F]">{index + 1}</td>
        ...
        {showScoreSubmissionModal && selectedTier && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
              <h3 className="text-lg font-semibold text-[#6F6F6F] mb-4">
                Submit Score - Tier {selectedTier}
              </h3>
