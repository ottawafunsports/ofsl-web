/*
  # Fix User Profile Function

  1. Changes
    - Create a function to check and fix user profiles
    - Make it accessible to authenticated users
    - Avoid accessing auth.users table directly
    - Focus only on public.users table operations

  2. Security
    - Function runs with invoker privileges (not security definer)
