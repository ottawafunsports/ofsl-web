/*
  # Enhanced User Profile Fix Function

  1. New Functions
    - `check_and_fix_user_profile_v3` - Improved version with better Google OAuth support
    - Handles edge cases with Google sign-ins more robustly
    - Provides detailed logging for troubleshooting
    - Ensures proper profile creation for all auth providers
...
-- Create an enhanced function to check and fix user profiles
  ...
  EXCEPTION
    WHEN unique_violation THEN
      ...
      BEGIN
        ...
        RAISE NOTICE 'Update result: %, rows affected: %', v_result, v_result;
      EXCEPTION
        WHEN others THEN
